...
As AI becomes progressively more integrated in our everyday lives, it is
natural to assume these technologies might one day dominate in creative
domains. In this discussion, we look specifically at AI and machine-generated
music. Can an algorithm ever attain the quality of a human composer? Will there
always remain something indefinable and transcendent about a human creation,
unreproducible by a machine imitator?
...
chatter bubbled from the growing crowd of students, professors, and music
enthusiasts gathering in the Beall concert hall, anticipating an hour of
cerebral music and Baroque discussion. A sudden hush descended as esteemed
pianist Winifred Kerner strode across the stage to the waiting Steinway.

She performed three pieces. Only one was a true Bach.

In a musical showdown not dissimilar to the famous chess match between Gary
Kasperov and chess machine Deep Blue, or the more recent headliner pitting [Go
master Lee Sedol against DeepMind’s
AlphaGo](https://en.wikipedia.org/wiki/AlphaGo_versus_Lee_Sedol), the Bach
concert was organized as a competition between a human composer and his machine
...
"Emmy"). Perhaps not a Bach expert or a music composer, but the brainchild of
...
could approach the nuance and sublimity of a human composer, much less a
composer of Bach's stature. So he proposed a challenge: three pieces would be
performed before a general audience:
...
Much to Larson's chagrin, the audience decided that *EMI's piece was the
genuine Bach.* Adding salt to the wound, Larson's own composition was mis-
attributed to EMI. (As for the real Bach, it was mis-attributed to Larson.) In
a remarkable triumph for computer-generated music, EMI duped an audience of 
experienced listeners into believing its music was written by a compositional
master.[^1]
...
and subtraction, then they won’t admit they were moved."[^2] There seems to be
something profoundly uncomfortable with attributing human qualities -- artistry,
creativity, emotion -- to a machine-generated artifact. Why? The issue does not
seem to stem from a reluctance to form emotional attachments to machines. If
you're old enough (but not too old) to have had a
...
simulated pet. Countless other
examples in film ([Her](https://en.wikipedia.org/wiki/Her_(film)), [Ex
Machina](https://en.wikipedia.org/wiki/Ex_Machina_(film)), [Blade
...
creations. If people are generally okay with granting emotional currency to
a digital artifact, then what is it about EMI exactly that makes it hard for people to
accept its music?
...
From the whisper of Muses, the mysterious spark of Ingenuity, the deep sensitivity
...
achievement. To grant equal status to a machine would discount art's *ethos*. 
If a machine can do it, what's so special about the human artist? In this sense,
the debate over EMI and AIVA stems not from a critique over the quality of
their output, but from the danger they represent to the art
community.
...
replacing it. Stuck on a melody? Use
...
What's after AIVA? As these technologies improve, it is natural to assume the
...
In this way, we might achieve a reasonable coexistance between machine and
human artistry, but questions remain. Highlighting a few:

* **Credit**: algorithms like AIVA must have a *training dataset* in order to
learn how to compose music. Of course, the pieces in the training set were
written by humans. If AIVA composes a new piece, does the credit go to the
algorithm, or to the artists is the training set? Before you answer, consider
that AIVA could very well be copying wholesale measures directly from its
...
copy wholesale measures directly from said set, with most listeners none the wiser.
...
Does a company have any more right over the music that it didn't compose? But
how can an algorithm claim meaningful ownership over its creations?
...
Looking for more? Check out these resources if you want to...

* **start building something!** Check out the [Magenta docs](https://magenta.tensorflow.org/get-started/)
...
[^1]:
    Want to hear EMI for yourself? It's on [YouTube](https://www.youtube.com/watch?v=Xm-GCAPidaY). 
    
    In a somewhat different vein, a few years ago, Google released an AI capable of composing Bach-like
